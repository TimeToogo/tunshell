...
- ![#834187](https://via.placeholder.com/15/834187/000000?text=+) Specifier argument for which mode the client should run as. Can be target mode (T) or local mode (L). These instruct the client to operate as a shell server or client respectively.
